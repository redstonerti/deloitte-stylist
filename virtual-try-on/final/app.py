...
SERPAPI_KEY = "fb5b48c9e0b288879e79514437fbe55805d05e2cc143dfc64472201c13011b69"
...
def call_azure_openai(style, mood, Era, season, gender):
    """
    ...
    try:
        ...
        if "shopping_results" in data:
            ...
            for i, item in enumerate(data["shopping_results"][:5]):
                ...
                result["link"]=result["title"]+" "+result["source"]
                print("--------------------------------------",result["link"],"--------------------------------------")
...
def index():
    ...
    if request.method == 'POST':
        ...
        queries = call_azure_openai(style, mood, Era, season, gender)
...
def get_outfit_json():
    ...
    try:
        ...
        if not all([style, mood, Era, season, gender]):
